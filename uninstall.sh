...
echo "- This script does not uninstall Docker, but it *does* reset it's configuration"
echo "  to factory defaults. A backup is taken in case you have manually adjusted"
echo "  the docker daemon configuration yourself."
